...
public class ExtractFeatureWithBioTag {
	private ParseTimeML parseTimeML;
	
	public ExtractFeatureWithBioTag(){
	...
	public static void main(String[] args) {
		...
		String outputFeatureDir = "resources/te3/TimeBank/bio/feature/";
		String outputShellDir = "command/bilou/";
		String modelDir = "resources/te3/TimeBank/bio/model/";
		String modelFilename = "TimeBank.model";
		String crfLogDir = "resources/te3/TimeBank/bio/crflog/";
		...
		ExtractFeatureWithBioTag extractor = new ExtractFeatureWithBioTag();
	...
	public void extractFeature(String inputTmlDir, String outputFeatureDir, String outputShellDir, String modelDir, String modelFilename, String crfLogDir, boolean isTrain){
		...
		for(File tmlFile : tmlFiles){
			...
			for(int i = 0; i < taggedTokenList.size(); i++){
				...
				String bioTag = taggedToken.getBioTag();
				
				/**
				 * BIO tag
				 * */
				trainFeatSb.append(bioTag);
