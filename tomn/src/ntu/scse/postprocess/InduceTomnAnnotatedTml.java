...
public class InduceTomnAnnotatedTml {
	private ParseTimeML parseTimeML;
	
	public InduceTomnAnnotatedTml(){
...
//		 * WikiWars
//		 * */
//		String inputTmlDir = "resources/wikiwars/testset/tml/";
//		String crfLogDir = "resources/wikiwars/testset/crflog/";
//		String outputTimeMLDir = "resources/wikiwars/testset/TimeML-output/";
		
		/**
		 * Tweets
		 * */
//		String inputTmlDir = "resources/tweets/testset/tml/";
//		String crfLogDir = "resources/tweets/testset/crflog/";
//		String outputTimeMLDir = "resources/tweets/testset/TimeML-output/";
		...
		InduceTomnAnnotatedTml inducer = new InduceTomnAnnotatedTml();
...
//		sb.append("python TE3-evaluation.py " + inputTmlDir + " " + outputTimeMLDir + " 0 > " + evaluationDir + "result/" + paths[paths.length - 3] + ".log");
...
//				int tokenEndCharPosition = taggedToken.getEndCharPosition();
				...
				if(predictTag.equals(CONST.TOMN_T) || predictTag.equals(CONST.TOMN_M) || predictTag.equals(CONST.TOMN_N)){
					isTimexCurrent = true;
				}else
					isTimexCurrent = false;
