...
public class InduceBilouNonOAnnotatedTml {
	private ParseTimeML parseTimeML;
	
	public InduceBilouNonOAnnotatedTml(){
	...
	public static void main(String[] args) {
		...
		String crfLogDir = "resources/te3/te3-platinum/bilou/crflog/";
		String outputTimeMLDir = "resources/te3/te3-platinum/bilou/TimeML-output/";
		...
		InduceBilouNonOAnnotatedTml inducer = new InduceBilouNonOAnnotatedTml();
	...
	public void induceAnnotatedTimeML(String inputTmlDir, String crfLogDir, String outputTimeMLDir, String outputShellDir, String evaluationDir){
		...
		sb.append("python TE3-evaluation.py " + inputTmlDir + " " + outputTimeMLDir + " 0 > " + evaluationDir + "result/bilou-nonO/" + paths[paths.length - 3] + ".log");
...
//				int tokenEndCharPosition = taggedToken.getEndCharPosition();
				...
				if(predictTag.equals(CONST.BILOU_B) || predictTag.equals(CONST.BILOU_I) || predictTag.equals(CONST.BILOU_L) || predictTag.equals(CONST.BILOU_U)){
					isTimexCurrent = true;
				}else
					isTimexCurrent = false;
